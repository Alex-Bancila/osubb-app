...
- **Current backend queue:** the team lane is #276 → #277 → (#278 and #279) → #280 → #281. Task normalization follows #283–#296, the 2026-09-10 schema issues #310–#321, the server commands #327–#345, and the leadership/points work #256–#262, each using its explicit `## Blocked by` section. Startable now: #276, #283, #285, #286, #287, #256, #261, #65, #66, #310, #311, #313; on the web side #322 and #326.
