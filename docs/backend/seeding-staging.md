...
- **Assignment modes** — direct with an Executor from creation; public with an open Queue and nobody in it; public with a Candidate waiting and still no Executor; public with a first-come Executor and two Members queued behind them.
