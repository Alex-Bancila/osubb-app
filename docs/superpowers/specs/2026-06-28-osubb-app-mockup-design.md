...
- **Scoring:** task points = **difficulty (1–5 ★, 1pt/star) × rating multiplier**
  ...
  punctare** opens from inside *Task nou* and *Acordă puncte* (and a header button).
- **Roles (8):** Recrut · Voluntar · Membru Activ · Membru cu Drept de Vot ·
  ...
  BC see all *Fișele Voluntarului*; BC receive **no** task/event notifications. Moderator = single
...
- **Task Tracker visibility:** volunteers see only their own *Fișă* (+ available/first-taker tasks)
  and leaderboard/gamification; managers (Responsabil/BCE/BC/Moderator) create tasks & award points;
  BC/Moderator also get *Fișele voluntarilor* + *Pentru Interne* (two auto sheets: AG threshold +
...
- **Recrutare** is a calendar **event** (not a nav screen); accepted recruits get auto-generated
  accounts from a CSV (random passwords) via *Importă recruți* in Panou BC.
