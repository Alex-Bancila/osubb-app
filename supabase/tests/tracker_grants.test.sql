...
select is(
  ...
  'the audited roster includes Groups Wave 1, the five #519 Origin bridge functions, the internal #50 Role history guard, #580''s two Member command bodies, and #603''s session-revoke helper');
