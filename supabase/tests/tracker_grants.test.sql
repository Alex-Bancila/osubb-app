...
select is(
  (select count(*) from pinned_private_functions)::int, 115,
  'the audited roster includes Groups Wave 1, the five #519 Origin bridge functions, the internal #50 Role history guard, and #580''s two Member command bodies');
