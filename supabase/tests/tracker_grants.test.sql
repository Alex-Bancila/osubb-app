...
select is(
  ...
  'the audited roster contains the 89 pre-#507 functions, the four Group invariant/predicate helpers (#507), the seven Group mirror syncs (#508) and the seven mirror trigger functions (#509), plus #50');
