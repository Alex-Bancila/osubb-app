...
insert into pinned_private_functions (proname, args, category) values
  ...
  -- public.evaluation_period_ranking is gated inside (own row, level >= 5
  -- until #512); the unfiltered core it reads is granted to nobody -- only
  -- security-definer bodies (#49, #48, #51) and the scheduler (#52) read it.
