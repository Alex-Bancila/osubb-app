...
select ok(not (select prosecdef from pg_proc where oid='public.update_event(bigint,text,text,bigint,timestamptz,timestamptz,text,integer,text,integer,bigint)'::regprocedure),'update wrapper is invoker');
...
select lives_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'Project Manager edits Event');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000003');
select lives_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Responsible','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'Project Responsible edits Event');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000004');
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'42501','calendar_manage_forbidden','ordinary member denied');
select throws_ok($q$select public.update_event((select id from ex where title='Hidden #248'),'Hidden','sedinta',(select id from gx where name='a'),now(),null,null,null,null,5,null)$q$,'PT404','event_not_found','hidden Event answers missing');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000005');
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'42501','calendar_manage_forbidden','unrelated Manager denied');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000002');
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='b'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'42501','calendar_manage_forbidden','moving requires target authority');
select lives_ok($q$select public.update_event((select id from ex where title='Event org #248'),'Updated','sedinta',(select id from gx where name='org'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'Organization creator edits own Event');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000003');
select throws_ok($q$select public.update_event((select id from ex where title='Event org #248'),'Updated','sedinta',(select id from gx where name='org'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'42501','calendar_manage_forbidden','other Group Role cannot edit Organization Event');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000001');
select lives_ok($q$select public.update_event((select id from ex where title='Event org #248'),'Updated','sedinta',(select id from gx where name='org'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'BC edits Organization Event');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000002');
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,3,null)$q$,'PT400','event_min_level_above_actor','Minimum Level ceiling enforced');
reset role;
update public.groups set min_level=3,application_level=3 where id=(select id from gx where name='b');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000001');
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='b'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'PT400','event_min_level_below_group','target Group floor enforced');
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,4,null)$q$,'PT400','invalid_event_min_level','retired level4 refused');
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),' ','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'PT400','invalid_event_title','blank title refused');
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','invalid',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'PT400','invalid_event_type','invalid type refused');
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00','2026-10-01 11:00+00',null,null,null,0,null)$q$,'PT400','invalid_event_interval','reversed interval refused');
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,0,null,0,null)$q$,'PT400','invalid_event_capacity','nonpositive capacity refused');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000008');
select lives_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,6,null)$q$,'Moderator may raise Minimum Level');
reset role;
...
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000002');
select lives_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Quiet','activitate',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,20,'Only text',0,null)$q$,'nonimportant edits succeed');
reset role;
...
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000002');
select lives_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-02 12:00+00','2026-10-02 13:00+00','Sala',null,null,0,null)$q$,'schedule and location change atomically');
reset role;
...
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000002');
select lives_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-03 12:00+00',null,'Sala',null,null,0,null)$q$,'subsequent unread schedule change coalesces');
reset role;
...
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000001');
select lives_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='b'),'2026-10-03 12:00+00',null,'Sala',null,null,3,null)$q$,'BC moves Event and raises floor');
reset role;
...
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000001');
select lives_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='b'),'2026-10-01 12:00+00',null,null,null,null,3,null)$q$,'nullable replacement fields can be cleared');
reset role;
...
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'42501','calendar_manage_forbidden','claimless denied');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000009');
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'42501','calendar_manage_forbidden','inactive denied');
reset role;
select pg_temp.test_clear_jwt();
set local role anon;
select throws_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Updated','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'42501',null,'anon cannot execute');
reset role;
...
select lives_ok($q$select public.update_event((select id from ex2 where title='Team ancestor #248'),'Ancestor','sedinta',(select group_id from ex2 where title='Team ancestor #248'),'2026-10-04 12:00+00',null,null,null,null,0,null)$q$,'a Department lead edits a Team Event through the Group path');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000012');
select throws_ok($q$select public.update_event((select id from ex2 where title='Team ancestor #248'),'Ancestor','sedinta',(select group_id from ex2 where title='Team ancestor #248'),'2026-10-04 12:00+00',null,null,null,null,0,null)$q$,'42501','calendar_manage_forbidden','a lead of another Department has no reach onto that path');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000002');
select lives_ok($q$select public.update_event((select id from ex2 where title='Move to org #248'),'To org','sedinta',(select id from gx where name='org'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'any live Group Role may move an Event onto the Organization Group');
reset role;
...
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000001');
select throws_ok($q$select public.update_event(-1,'Updated','sedinta',(select id from gx where name='a'),'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'PT404','event_not_found','an unknown Event answers missing');
reset role;
select pg_temp.test_login('24800000-0000-0000-0000-000000000001','{}');
select throws_ok($q$select public.update_event((select id from ex2 where title='Team ancestor #248'),'Updated','sedinta',null,'2026-10-01 12:00+00',null,null,null,null,0,null)$q$,'PT400','event_group_required','a null Group is malformed input, named before the gate');
reset role;
update public.groups set status='archived' where id=(select id from gx where name='b');
reset role;
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000001');
select throws_ok($q$select public.update_event((select id from ex2 where title='Team ancestor #248'),'Updated','sedinta',(select id from gx where name='b'),'2026-10-04 12:00+00',null,null,null,null,3,null)$q$,'42501','calendar_manage_forbidden','an Event cannot be moved into an archived Group');
...
select lives_ok($q$select public.update_event((select id from ex where title='Event a #248'),'Archived-group edit','sedinta',(select id from gx where name='b'),'2026-10-01 12:00+00',null,null,null,null,3,null)$q$,'BC still edits an Event whose own Group has been archived');
reset role;
-- ==================== #691: a Campaign on an Event ====================
-- Group a is a root Project Group managed by member 2; `Child a #691` sits below
-- it. A Campaign is a label: it rides the full-state replace, is judged by
-- events_validate_campaign against the Event's (new) Group, answers as
-- PT400 invalid_campaign, and never notifies anybody.
select pg_temp.test_clear_jwt();
select is((select count(*) from pg_proc p join pg_namespace n on n.oid=p.pronamespace
           where (n.nspname,p.proname) in (('public','update_event'),('private','update_event_impl'))),
          2::bigint,'update_event and update_event_impl each exist under exactly one signature');
insert into public.groups(name,category,parent_id) values ('Child a #691','team',(select id from gx where name='a'));
insert into public.campaigns(group_id,name,is_active,created_by) values
((select id from gx where name='a'),'A campaign #691',true,'24800000-0000-0000-0000-000000000001'),
((select id from gx where name='a'),'A inactive #691',false,'24800000-0000-0000-0000-000000000001'),
((select id from gx where name='a'),'A later #691',true,'24800000-0000-0000-0000-000000000001'),
((select id from gx where name='org'),'Org campaign #691',true,'24800000-0000-0000-0000-000000000001');
create temp table cx as select id,name from public.campaigns where name like '%#691';
grant select on cx to authenticated;
insert into public.events(title,type,group_id,starts_at,created_by,min_level)
select 'Campaign edit #691','sedinta',id,'2026-10-05 12:00+00','24800000-0000-0000-0000-000000000002',0 from gx where name='a';
create temp table e691 as select id from public.events where title='Campaign edit #691';
grant select on e691 to authenticated;
create function pg_temp.edit691(p_group text, p_campaign text, p_title text default 'Campaign edit #691')
returns public.events language sql as $f$
  select public.update_event((select id from e691),p_title,'sedinta',
    (select id from public.groups where name=p_group or id=(select id from gx where name=p_group)),
    '2026-10-05 12:00+00',null,null,null,null,0,(select id from cx where name=p_campaign));
$f$;
grant execute on function pg_temp.edit691(text,text,text) to authenticated;
delete from public.notifications where member_id::text like '24800000-%';
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000002');
select lives_ok($q$select pg_temp.edit691('a','A campaign #691')$q$,'update_event attaches a Campaign of the Event''s own Group');
reset role;
select is((select campaign_id from public.events where id=(select id from e691)),(select id from cx where name='A campaign #691'),'the Campaign is stored');
select is((select count(*) from public.notifications where member_id::text like '24800000-%'),0::bigint,'a Campaign-only change is not an important change: zero notifications');
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000002');
select throws_ok($q$select pg_temp.edit691('a','Org campaign #691')$q$,'PT400','invalid_campaign','a Campaign off the Event Group''s path is PT400 invalid_campaign, not a raw 23514');
select throws_ok($q$select pg_temp.edit691('a','A inactive #691')$q$,'PT400','invalid_campaign','attaching an inactive Campaign is PT400 invalid_campaign');
select lives_ok($q$select pg_temp.edit691('a','A later #691')$q$,'an active Campaign is attached');
reset role;
update public.campaigns set is_active=false where name='A later #691';
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000002');
select lives_ok($q$select pg_temp.edit691('a','A later #691','Campaign edit #691 (kept)')$q$,'a Campaign deactivated after it was attached survives an edit that sends it back');
reset role;
select is((select campaign_id from public.events where id=(select id from e691)),(select id from cx where name='A later #691'),'the now-inactive Campaign is preserved, not cleared');
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000002');
select lives_ok($q$select pg_temp.edit691('a',null)$q$,'a null Campaign is accepted');
reset role;
select is((select campaign_id from public.events where id=(select id from e691)),null::bigint,'full-state replace: a null Campaign clears it');
select pg_temp.test_login_leadership('24800000-0000-0000-0000-000000000002');
select lives_ok($q$select pg_temp.edit691('Child a #691','A campaign #691')$q$,'a move below the Campaign''s Group keeps an ancestor''s Campaign valid');
select throws_ok($q$select pg_temp.edit691('org','A campaign #691')$q$,'PT400','invalid_campaign','a move that carries the Campaign off the new Group''s path is refused');
reset role;
select ok((select group_id=(select id from public.groups where name='Child a #691') and campaign_id=(select id from cx where name='A campaign #691') from public.events where id=(select id from e691)),'the refused move left the Event and its Campaign where they were');
...
select throws_ok($$ select public.update_event(0, 'ab', 'sedinta', 0, now() + interval '1 day', null, null, null, null, 0, null) $$,
  'PT400', 'title_too_short', 'an Event title under 3 characters is refused before the gate');
select throws_ok($$ select public.update_event(0, 'Eveniment #673', 'sedinta', 0, now() + interval '1 day', null, null, null, repeat('d', 2001), 0, null) $$,
  'PT400', 'description_too_long', 'an Event description over 2000 characters is refused before the gate');
select throws_ok($$ select public.update_event(0, 'Eveniment #673', 'sedinta', 0, now() + interval '1 day', null, null, 1001, null, 0, null) $$,
