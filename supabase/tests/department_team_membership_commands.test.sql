...
select pg_temp.login('27900000-0000-0000-0000-000000000001','bce',5);
...
select pg_temp.login('27900000-0000-0000-0000-000000000002','bce',5);
select is((select m.member_id from public.add_department_team_member(
...
select pg_temp.login('27900000-0000-0000-0000-000000000003','bc',6);
select is((select m.member_id from public.add_department_team_member(
...
reset role;
select pg_temp.login('27900000-0000-0000-0000-000000000004','moderator',9);
select is(public.remove_department_team_member('department-team-279-edu',
...
select pg_temp.login('27900000-0000-0000-0000-000000000005','responsabil',4);
select throws_ok($$select public.add_department_team_member('department-team-279-edu',
  '27900000-0000-0000-0000-000000000009')$$, '42501','department_team_membership_forbidden',
  'Responsabil (level 4) is denied');
reset role;
select pg_temp.login('27900000-0000-0000-0000-000000000006','voluntar',1);
select throws_ok($$select public.add_department_team_member('department-team-279-edu',
  '27900000-0000-0000-0000-000000000009')$$, '42501','department_team_membership_forbidden',
  'Voluntar is denied');
reset role;
select pg_temp.login('27900000-0000-0000-0000-000000000007','bce',5);
select throws_ok($$select public.add_department_team_member('department-team-279-edu',
  '27900000-0000-0000-0000-000000000009')$$, '42501','department_team_membership_forbidden',
...
select set_config('request.jwt.claims',jsonb_build_object('sub','27900000-0000-0000-0000-000000000003',
