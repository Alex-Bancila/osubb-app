...
), false), 'the evaluator''s Department membership row -- the one their authority rests on -- is locked FOR SHARE too, since a BCE (unlike BC/Moderator) reaches that branch');
