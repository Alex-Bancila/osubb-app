...
insert into public.tasks
  (title, difficulty, dept_id, status, assignment_mode, created_at, cancel_reason, rating)
values
  ('Legacy todo timestamps 293', 1, 'edu', 'todo', 'direct', '2026-01-01 10:00+00', null, null),
  ('Legacy progress timestamps 293', 1, 'edu', 'in_progress', 'direct', '2026-01-02 10:00+00', null, null),
  ('Legacy review timestamps 293', 1, 'edu', 'in_review', 'direct', '2026-01-03 10:00+00', null, null),
  ('Legacy completed timestamps 293', 1, 'edu', 'completed', 'direct', '2026-01-04 10:00+00', null, 3),
  ('Legacy unfulfilled timestamps 293', 1, 'edu', 'unfulfilled', 'direct', '2026-01-05 10:00+00', null, 2),
  ('Legacy cancelled timestamps 293', 1, 'edu', 'cancelled', 'direct', '2026-01-06 10:00+00', 'Anulat #293', null),
  ('Legacy public todo timestamps 293', 1, 'edu', 'todo', 'public', '2026-01-07 10:00+00', null, null),
  ('Legacy public completed timestamps 293', 1, 'edu', 'completed', 'public', '2026-01-08 10:00+00', null, 4);
