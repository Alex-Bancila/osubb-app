...
insert into public.tasks (title, dept_id, created_by) values
  ('TM320 dept task A', 'edu', '32000000-0000-0000-0000-000000000101');
insert into public.tasks (title, team_id, created_by) values
  ('TM320 deptteam task B', 'tm320-deptteam', '32000000-0000-0000-0000-000000000201');
insert into public.tasks (title, team_id) values
  ('TM320 indepteam task C', 'tm320-indepteam');
insert into public.tasks (title, project_id)
select 'TM320 project task D', project.id
  from public.projects as project
 where project.name = 'TM320 Helper Project';
insert into public.tasks (title, team_id) values
